...
def init_args():
    ...
    parser.add_argument('--model_path', default=r'/root/DBNet.pytorch/output/DBNet_resnet50_FPN_DBHead/checkpoint/model_best.pth', type=str)
    parser.add_argument('--input_folder', default='/root/DBNet.pytorch/test/input', type=str, help='img path for predict')
    parser.add_argument('--output_folder', default='/root/DBNet.pytorch/test/output', type=str, help='img path for output')
